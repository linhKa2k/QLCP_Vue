  ...
  <a-row>
    <a-col :span="24">
      <a-card
        :bordered="false"
        class="card-border"
        :title="$t('province.title.general_information')"
      >
          ...
          <a-col :span="24">
            <a-form layout="vertical" :model="form">
              <a-row :gutter="[16, 0]">
                ...
                <!-- <a-col :span="12">
                  <a-form-item :label="fields['area_id'].label">
                    <span>{{ form.area.name ? form.area.name : "-" }}</span>
                  </a-form-item>
                </a-col> -->
                <!-- <a-col :span="12">
                ...
                <!-- <a-col :span="12">
                  <a-form-item :label="fields['type'].label">
                    <span>{{
                      form.type ? formatTypeProvince(form.type) : "-"
                    }}</span>
                  </a-form-item>
                </a-col> -->
              </a-row>
      ...
      <!-- <a-card
        :bordered="false"
        class="card-border"
        :title="$t('province.title.additional_information')"
      >
        <a-row type="flex" justify="center" align="middle">
          <a-col :span="24">
            <a-form layout="vertical" :model="form">
...
import { formatDate, formatTypeProvince, formatIsActive } from "@/utility";
import * as _ from "lodash";
import { watch, ref, toRefs } from "vue";
import ColumnConfig from "@/config/columns";
import i18n from "@/lang";
const { t } = i18n.global;
const entity = "province";
interface Props {
  isShowModal: boolean;
  isAutoLoad: boolean;
  isAdd: boolean;
