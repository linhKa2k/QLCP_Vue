<template>
  ...
  <a-modal
    ...
    :title="$t('policyLimit.name', { code: form.code })"
    :destroyOnClose="true"
    :closable="true"
    @cancel="hideModal"
    @ok="hideModal"
...
import { useGetList, useDetail, useSaveMutation } from "@/hooks/policy_limit";
import { ref, computed, watch } from "vue";
import i18n from "@/lang";
import { message } from "ant-design-vue";
const { t } = i18n.global;
const entity = "policy_limit";
const baseUrl = "policy-limits";
const form = ref<any>({});
