  ...
  <a-row>
    <a-col :span="24">
      <a-card
        :bordered="false"
        class="card-border"
        :title="$t('district.title.general_information')"
      >
              ...
              <a-row :gutter="[16, 0]">
                ...
                <a-col :span="24">
                  <a-form-item :label="fields['province_id'].label">
                    <span>{{
                      form.province ? form.province.name : "-"
                    }}</span>
                  </a-form-item>
                </a-col>
                <a-col :span="24">
                ...
                <!-- <a-col :span="12">
                  <a-form-item :label="fields['type'].label">
                    <span>{{
                      form.type ? formatTypeDistrict(form.type) : "-"
                    }}</span>
                  </a-form-item>
                </a-col> -->
              </a-row>
