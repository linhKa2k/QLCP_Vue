<template>
  ...
  <a-modal
    ...
    :title="$t('airportQuota.name', { code: form.code })"
    :destroyOnClose="true"
    :closable="true"
    @cancel="hideModal"
    @ok="hideModal"
...
import { useGetList, useDetail, useSaveMutation } from "@/hooks/airport_quota";
import { ref, computed, watch } from "vue";
import i18n from "@/lang";
import { message } from "ant-design-vue";
const { t } = i18n.global;
const entity = "airport-quota";
const baseUrl = "airport-quotas";
