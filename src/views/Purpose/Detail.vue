  ...
  <a-row>
    <a-col :span="24">
      <a-card
        :bordered="false"
        class="card-border"
        :title="$t('area.title.general_information')"
      >
        <a-row type="flex" justify="center" align="middle">
          <a-col :span="24">
            <a-form layout="vertical" :model="form">
              ...
              <a-row :gutter="16">
                <a-col :span="24">
                  <a-form-item :label="fields['is_cost'].label">
                    <span>{{ formatIsCostPrediction(form.is_cost) }}</span>
                  </a-form-item>
                </a-col>
              </a-row>
              <a-row :gutter="16">
                <a-col :span="24">
                  <a-form-item :label="'Chi phí áp dụng'" name="position">
                    {{ renderArray(form.purpose_service_group, "service_group", "name") }}
                  </a-form-item>
                </a-col>
              </a-row>
              <a-row :gutter="[16, 0]">
      ...
      <a-card
        :bordered="false"
        class="card-border"
        :title="$t('area.title.additional_information')"
      >
        <a-row type="flex" justify="center" align="middle">
          <a-col :span="24">
            <a-form layout="vertical" :model="form">
