  ...
  <a-row>
    <a-col :span="24">
      <a-card
        :bordered="false"
        class="card-border"
        :title="$t('movingQuota.title.general_information')"
      >
        <a-row type="flex" justify="center" align="middle">
          <a-col :span="24">
            <a-form layout="vertical" :model="form">
              ...
              <a-row :gutter="[16, 0]">
                <a-col :span="12">
                  <a-form-item :label="fields['from_distance'].label">
                    <span>{{ form.to_distance ? formatNumber(form.from_distance) : "-" }}</span>
                  </a-form-item>
                </a-col>
                <a-col :span="12">
                  <a-form-item :label="fields['to_distance'].label">
                    <span>{{ form.to_distance ? formatNumber(form.to_distance) : "-" }}</span>
                  </a-form-item>
                </a-col>
              </a-row>
              <a-row :gutter="[16, 0]">
      ...
      <a-card
        :bordered="false"
        class="card-border"
        :title="$t('movingQuota.title.additional_information')"
      >
        <a-row type="flex" justify="center" align="middle">
          <a-col :span="24">
            <a-form layout="vertical" :model="form">
...
import { formatIsActive, formatCurrency, formatNumber } from "@/utility";
