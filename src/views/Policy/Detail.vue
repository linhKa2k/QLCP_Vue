  ...
  <a-row>
    <a-col :span="24">
      <a-card
        :bordered="false"
        class="card-border"
        :title="$t('policy.title.general_information')"
      >
          ...
          <a-col :span="24">
            <a-form layout="vertical" :model="form">
              <a-row :gutter="[16, 0]">
                ...
                <a-col :span="12">
                  <a-form-item :label="fields['publish_time'].label">
                    <span>{{
                      form.publish_time ? formatDate(form.publish_time) : "-"
                    }}</span>
                  </a-form-item>
                </a-col>
                <a-col :span="12">
                  <a-form-item :label="fields['expire_time'].label">
                    <span>{{ form.expire_time ? formatDate(form.expire_time) : "-" }}</span>
                  </a-form-item>
                </a-col>
                <a-col :span="12">
                ...
                <a-col :span="12">
                  <a-form-item :label="fields['end_time'].label">
                    <span>{{ form.end_time ? formatDate(form.end_time) : "-" }}</span>
                  </a-form-item>
                </a-col>
                <a-col :span="12">
                  <a-form-item :label="fields['sort_order'].label">
                    <span>{{ form.sort_order ? form.sort_order : "-" }}</span>
                  </a-form-item>
                </a-col>
                <a-col :span="12">
      ...
      <a-card
        :bordered="false"
        class="card-border"
        :title="$t('policy.title.additional_information')"
      >
        <a-row type="flex" justify="center" align="middle">
          <a-col :span="24">
            <a-form layout="vertical" :model="form">
