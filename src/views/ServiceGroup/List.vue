<template>
  ...
  <a-modal
    ...
    :title="$t('serviceGroup.name', { code: form.code })"
    :destroyOnClose="true"
    :closable="true"
    @cancel="hideModal"
    @ok="hideModal"
...
import { useGetList, useDetail, useSaveMutation } from "@/hooks/service_group";
import { ref, computed, watch } from "vue";
import i18n from "@/lang";
import { message } from "ant-design-vue";
const { t } = i18n.global;
const entity = "service-group";
const baseUrl = "service-groups";
const form = ref<any>({});
